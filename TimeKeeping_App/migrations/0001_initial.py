# Generated by Django 5.1.5 on 2025-10-12 10:22
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employee_type', models.CharField(choices=[('Employee', 'Employee'), ('Intern', 'Intern')], max_length=10, null=True)),
                ('username', models.CharField(max_length=100, unique=True)),
                ('password', models.CharField(max_length=100)),
                ('yearly_counter', models.PositiveIntegerField(default=1)),
